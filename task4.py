...
if __name__ == '__main__':
    ...
    for epoch in range(1, 100):
        ...
        if train_loss < best_train_loss:
            ...
            torch.save(model.state_dict(), '/home/pi/ee347/lab8/best_model.pth')

        # Save the model
        torch.save(model.state_dict(), '/home/pi/ee347/lab8/current_model.pth')
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig('/home/pi/ee347/lab8/task2_loss_plot.png')